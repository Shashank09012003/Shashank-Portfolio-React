...
export default function Contact() {
  ...
  console.log("Validation passed, sending request..."); // Debug line
  ...
  try {
    console.log("Making fetch request..."); // Debug line
              ...
              <div className="space-y-6">
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400">shashanksharma7581@gmail.com</p>
                  </div>
                </div>
