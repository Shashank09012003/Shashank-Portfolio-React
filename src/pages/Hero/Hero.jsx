...
export default function Hero() {
  const words = [
    ...
    "Learning Three.js, WebGL & Shaders",
...
const profile = {
    ...
    title: 'Frontend Developer | MERN Specialist | Three.js Practitioner'
    skills: [
        'ReactJS', 'Redux', 'Tailwind CSS', 'GSAP',
        'HTML', 'JavaScript', 'Three.js'
        'Git', 'VS Code', 'Animations',
            ...
            <div className="w-full lg:w-1/2 mb-12 lg:mb-0 animate__animated animate__fadeInLeft relative">
              ...
              <div className="relative mb-8 sm:mb-12 max-w-xl">
                <p className="text-base sm:text-xl text-gray-300/90 leading-relaxed">
                  MERN/Next.js UI Developer 🚀 | Building fast, responsive
                  modern webapps ⚡
                </p>
              </div>
              ...
              <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 animate__animated animate__fadeInUp animate__delay-2s">
                ...
                {/* Contact Button */}
                <a
                  href="https://drive.google.com/file/d/1J9FwHdT3YVCAdRvcCZo7vjkDH2P5y38t/view?usp=drivesdk"
              ...
              {/* Floating badges */}
              <div className="hidden lg:block absolute left-[12.8rem] top-[2.3rem] animate-float-slow">
