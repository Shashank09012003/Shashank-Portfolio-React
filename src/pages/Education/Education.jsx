...
const EducationSection = () => {
  ...
  const educationData = [
  {
    ...
    school: "KidZworld International School",
    mascot: "📘",
    year: "2017 - 2018",
    achievements: ["Percentage: 60%", "Board: CBSE Board"],
  ...
  },
  {
    ...
    school: "Leonard School",
    mascot: "📗",
    year: "2019 - 2020",
    achievements: ["Percentage: 65%", "Stream: Physics, Chemistry, Maths"],
  ...
  },
  {
    ...
    mascot: "🎓",
    year: "2020 - 2023",
    achievements: ["CGPA: 5.8", "Branch: Computer Applications"],
    skills: ["Programming", "Data Structures", "Web Development", "JavaScript"],
    description:
      "Completed BCA with core computer science foundation and practical exposure in software development and modern front-end (JavaScript, React).",
  },
];
